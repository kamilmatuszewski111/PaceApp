...
class PaceApp(App):
    ...
    def main_screen(self):
        ...
        self.select_speed_button = Button(text='Calculate speed')
        self.select_speed_button.bind(on_press=self.speed_screen)
        self.layout.add_widget(self.select_speed_button)

        self.select_pace_button = Button(text='Calculate distance')
    ...
    def speed_screen(self, instance):
        ...
        self.time_input = TextInput(hint_text='Podaj czas (hh:mm:ss)')
        self.layout.add_widget(self.time_input)

        self.pace_input = TextInput(hint_text='Podaj tempo (mm:ss)')
        self.layout.add_widget(self.pace_input)

        self.result_label_speed = Label(text='Prędkośc na podstawie tempa oraz czasu')
        self.layout.add_widget(self.result_label_speed)

        self.calculate_button = Button(text='Oblicz')
    ...
    def distance_screen(self, instance):
        ...
        self.result_label_distance = Label(text='Dystans na podstawie tempa oraz czasu')
    ...
    def calculate_speed(self, instance):
        ...
        try:
            speed = time_pace_to_speed(time, pace)
            self.result_label_speed.text = f"Średnia prędkość: {speed:.2f} km/h"
    ...
    def calculate_distance(self, instance):
        ...
        try:
            ...
            self.result_label_distance.text = f"Przebyty dystans: {distance:.2f} km"
        except Exception as e:
